...
class _usereditprofileState extends State<usereditprofile> {
  ...
  Future<void> _sendData() async {
    ...
    final uri = Uri.parse('$url/edit_userprofile_POST/');
    ...
    try {
      ...
      if (response.statusCode == 200 && data['status'] == 'ok') {
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context)=>view_profile(title: '',)));
      ...
      if (response.statusCode == 200) {
        ...
        if (status=='ok') {
          ...
          setState(() {
           ...
           _statetextController.text=data['state'];
           _districttextController.text=data['disrict'];
           _dobtextController.text=data['dob'];
           _numbertextController.text=data['number'];
           _emailtextController.text=data['email'];
           _placetextController.text=data['place'];
           _pincodetextController.text=data['pincode'];
           photo=img_url+data['photo'];
           _gendertextController.text=data['gender'];
